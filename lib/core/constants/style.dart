...
abstract final class AppEmptySpace {
  ...
  static const SizedBox verticalNormal = SizedBox(height: 8);
  static const SizedBox verticalLarge = SizedBox(height: 12);
  static const SizedBox verticalXl = SizedBox(height: 16);
  static const SizedBox horizontalSmall = SizedBox(width: 4);
  static const SizedBox horizontalNormal = SizedBox(width: 8);
  static const SizedBox horizontalLarge = SizedBox(width: 12);
  static const SizedBox horizontalXl = SizedBox(width: 16);
}
